...
def get_dataloaders(dataset_name='jxie/stl10', batch_size=64, num_workers=2):
    ...
    real_dataset = copy.deepcopy(full_dataset)
...
def generate_and_save_images(config, pipeline, accelerator, total_images=23000):
...
def save_real_images(config, real_dataloader, total_images=23000):
