...
class TrainingConfig:
    ...
    output_dir = "eurosat_64"
    seed = 1211
    eval_batch_size = 64
    gen_num_images = 27000
...
def get_dataloaders(dataset_name='nielsr/eurosat-demo', batch_size=64, num_workers=2):
...
def generate_and_save_images(config, pipeline, accelerator, total_images=27000):
...
def save_real_images(config, real_dataloader, total_images=27000):
